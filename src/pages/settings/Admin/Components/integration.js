  ...
  render() {
    return (
      <Grid style={{ marginTop: "10%",  display: "flex", flexDirection: "row", gap: 30 }}>
        ...
        <Grid>
        <Typography style={{ fontSize: "20px", fontWeight: "600", marginBottom: "3%" }}>Integration</Typography>
        <Grid style={{ display: "flex", flexWrap: "wrap", gap: "30px" }}>
          <Grid style={{ width: "250px", boxShadow: "0px 0px 7px 0px #00000040", padding: "14px", borderRadius: "6px" }}>
            <a style={{ textDecoration: "none" }} href="/integrationdetailpage">
            ...
            <a style={{ textDecoration: "none",cursor:"pointer" }} href="/integrationdetailpage">
              <Box>
