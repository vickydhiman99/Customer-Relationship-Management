...
// import { BarChart, BarPlot, XAxis } from '@mui/x-charts/BarChart';
  ...
  render() {
    ...
    return (
      <>
                ...
                <Grid>
                  <Tabs style={{ width: "450px" }}>
                    <TabList className="main-tab">
                      ...
                      <Tab><Typography style={{ color: "#AA3F1D", fontWeight: "600" }}>Executives</Typography></Tab>
                    </TabList>
                    <TabPanel>
        ...
        <Dialog
          open={this.state.adddetails} style={{}}>
          <Grid style={{ height: "auto", width: "450px", marginBottom: "30px", cursor: "pointer" }}>

            <Box >
              <CloseIcon
                onClick={() => { this.setState({ adddetails: false }); }}
        ...
        <Dialog open={this.state.Call} >
          <Box style={{ padding: "1em", width: "600px", backgroundColor: "white", "display": "flex", "backgroundColor": "white", "flexDirection": "column", "alignItems": "center" }}>
