...
export default class Executivedetailsnext extends Component {
    constructor(props) {
        super(props);
        this.state = {
            viewData: false,
        ...
        return (
            <Grid style={{ marginTop: "10%" }}>
                ...
                <Grid style={{ display: "flex", flexDirection: "row", marginLeft: "1%", gap: 25 }}>
                    <Grid>
                        <Card style={{ width: "280px", boxShadow: "2px 2px 8px 0px #66666633" }}>
                    ...
                    <Card style={{
                        width: "500px", boxShadow: "2px 2px 8px 0px #66666633"
                    }}>
                                ...
                                <Grid style={{ padding: 20 }} >
                                    ...
                                    <Card style={{ padding: 10, marginTop: "2%" }}>
                                        ...
                                        <Grid>
                                            ...
                                            <Typography style={{ fontSize: 13, whiteSpace: "nowrap" }}>Lorem ipsum dolor sit amet. Cum perferendis voluptas ex minima architecto qui </Typography>
                                        </Grid>
                    ...
                    <Grid>
                        <Card style={{ width: "220px", boxShadow: "2px 2px 8px 0px #66666633", padding: 20, height: "100%" }}>
                ...
                >
                    ...
                    <Box style={{ width: "100%" }}>
                        ...
                        <div style={{ display: "flex", flexDirection: "row", justifyContent: "space-between", padding: "14px", }} >
                            ...
                            <InsertLinkIcon />
                            <Button style={{ backgroundColor: "#3D3B3B" }} variant="contained">Send</Button>
                        </div>
 ...
 <Dialog
                ...
                <Button  onClick={() => {
                                this.setState({ folloup: false });
                            }} style={{width:"40px",left:"33em",margin:"1em"}} variant="contained">Save</Button>
