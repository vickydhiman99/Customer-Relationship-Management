                ...
                <Grid style={{ marginTop: "10%", padding: "20px" }}>
                    ...
                    <Dialog
                        ...
                        <Grid style={{ width: "400px", padding: "20px", justifyContent: "center", alignItems: "center" }}>
                            ...
                            <Grid style={{ display: "flex", justifyContent: "space-between",cursor:"pointer" }}>
                            ...
                            <Grid style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }}>
                                ...
                                <Grid>
                                    ...
                                    <TextField id="standard-basic" variant="standard" disabled style={{ width: "250px", marginLeft: "2%", marginTop: "-7px" }} />
                                </Grid>
                                <Grid>
                                ...
                                <button
                                    ...
                                    style={{ border: "none",cursor:"pointer", borderRadius: "2px", outline: "none", color: "white", background: "#441000", padding: "10px", width: "80%", borderRadius: "2px", marginTop: "2%" }}>
                                    Okay
                                </button>
