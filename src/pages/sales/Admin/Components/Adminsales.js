   ...
   <>
        <Tabs style={{marginTop:"80px"}}>
          ...
          <Grid
            ...
            <TabList className="sales" style={{ display:"flex",flexDirection:"row",justifyContent:"space-between",width:"100%",marginLeft:"6%",marginRight:"7%" }}>
              ...
              <Grid>
                <TableContainer style={{ width: "900px" }} component={Paper}>
                  <Table aria-label="customized table">
                    ...
                    <TableBody>
                      {this.state.Adminsalesdate.map((item, index) => {
                        return (
                          <TableRow>
                  ...
                  <CardContent>
                    <Box>
                      <Card style={{ boxShadow: "none" }}>
                        ...
                        {this.state.adminorgdata.map((adminorgdata, index) => (
                          <>
                            <Box
                              style={{
                                display: "flex",
              ...
              <Grid>
                <TableContainer style={{ width: "900px" }} component={Paper}>
                  <Table aria-label="customized table">
                    ...
                    <TableBody>
                      {this.state.adminpaymentdata.map((item, index) => {
                        return (
                          <TableRow>
                            {/* <Link to="/user" className="table-row" style={{ display: "contents", textDecoration: "none" }}> */}
                            <TableCell></TableCell>
