...
export default class ExecutiveLeadsDetails extends Component {
    constructor(props) {
        super(props);
        this.state = {
            viewData: false,
    ...
    render() {
        return (
            <Grid style={{ marginTop: "10%", marginBottom: "5%" }}>
                            ...
                            <TabPanel>
                                ...
                                <Grid style={{ padding: 15 }}>
                                    ...
                                    <Card style={{ padding: 10 }}>
                                        ...
                                        <Button size='small' style={{ backgroundColor: "#3D3B3B", color: "#fff", marginTop: "2%", }}>Add Note</Button>
                                        </Box>
                                    </Card>
                    ...
                    <Grid>
                        <Card style={{ width: "270px", boxShadow: "2px 2px 8px 0px #66666633", padding: 20, height: "100%" }}>
                            ...
                            <Button
                                ...
                                size='small' variant='outlined' style={{ borderColor: "black", color: "#fff", marginTop: "10%", marginRight: "2%", color: "black",width:"100%" }}><AddOutlinedIcon />Create New Deal</Button>
                ...
                >
                    {/* <Grid style={{ height: "300px", width: "500px" }}> */}
                    ...
                    <Box style={{ width: "100%" }}>
                        ...
                        <div style={{ display: "flex", flexDirection: "row", justifyContent: "space-between", padding: "15px" }}>
                            <ListItem>
                                ...
                                <ListItemText primary="Asutosh panda" />
                            </ListItem>
                        ...
                        <div style={{ display: "flex", flexDirection: "row", justifyContent: "space-between", padding: "23px" }}>
                            ...
                            <Box style={{ display: "flex", flexDirection: "row", justifyContent: "space-between", alignItems: "center" }}>
                                ...
                                <Box>
                                    ...
                                    <ListItem style={{ backgroundColor: "#EBEBEB", borderRadius: "27px", marginLeft: "10px" }}>
                                        <ListItemAvatar>
                                            <Avatar>
                                                <ImageIcon />
                                            </Avatar>
                                        </ListItemAvatar>
                                        <ListItemText primary="aman panda" />
                                    </ListItem>
                                </Box>

                            </Box>
                            <Box style={{ display: "flex", flexDirection: "row", justifyContent: "space-between", alignItems: "center", gap: "10px" }}>
                                <Typography variant="subtitle1" component="h2">
                                    Cc
                                </Typography>
                                <Typography variant="subtitle1" component="h2">
                        ...
                        <Divider />
                        <TextareaAutosize style={{ margin: "15px", width: "90%" }} aria-label="minimum height" minRows={6} placeholder="Minimum 3 rows" />
                        <div style={{ display: "flex", flexDirection: "row", justifyContent: "space-between", padding: "14px", }} >
                            ...
                            style={{ backgroundColor: "#3D3B3B" }} className='create-btn' variant="contained">Send</Button>
                        </div>
                ...
                <Dialog open={this.state.paymentmodal}>
                    <Box style={{ width: "560px",padding:"10px",alignItems:"center",padding:"1em"}}>
                        ...
                        <Tabs style={{marginTop:"3%"}}>
                            ...
                            <TabPanel>
                                <Box style={{marginTop:"3%", "marginLeft": "3em","marginBottom": "1em","width": "80%", "gap": "26px", "display": "flex", "flexDirection": "column" }}>
                                    ...
                                    <Button style={{ width: "3em", left: "26em", backgroundColor: "grey" }} className='create-btn' variant="contained">Submit</Button>
                                </Box>
