...
// -----------------------mui properties start---------------------//
export default class ExecutiveLeads extends Component {
  constructor(props) {
    super(props);
        ...
        <Box sx={{ width: '100%', marginTop: "2%" }}>
          <Box sx={{ borderBottom: 1, borderColor: 'divider', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <Grid sx={{ display: 'flex', gap: '20px', alignItems: 'center', marginRight: '22px' }}>
              <img onClick={() => this.setState({ inbox: true })} src={inbx} alt="" style={{ height: '24px', width: '24px', display: 'flex', justifyContent: 'center', alignItems: 'center', flexShrink: 0 }} />
              <img onClick={() => this.setState({ document: true })} src={doc} alt="" style={{ height: '24px', width: '24px', display: 'flex', justifyContent: 'center', alignItems: 'center', flexShrink: 0 }} />
              {/* <img onClick={() => this.setState({ add: true })} src={addcircle} alt="" style={{ height: '24px', width: '24px', display: 'flex', justifyContent: 'center', alignItems: 'center', flexShrink: 0 }} /> */}
              {/* <img onClick={() => this.setState({ deleteleadadmin: true })} src={trs} alt="" style={{ height: '24px', width: '24px', display: 'flex', justifyContent: 'center', alignItems: 'center', flexShrink: 0 }} /> */}
            </Grid>
          </Box>
          <div
            role="tabpanel"
                    ...
                    <TableBody>
                      {rows.map((row) => (
                        ...
                        >
                          ...
                          <TableCell align="start"><Link to="/ExecutiveLeadsDetails">
        ...
        >
          <Box sx={{ height: '378px', width: '604px', borderRadius: '12px', position: 'absolute', top: '23vh', left: '35vw', backgroundColor: '#FFF', boxShadow: '0px 8px 16px 0px #7B7B7B' }}>
            ...
            <Grid style={{ display: 'flex', flexDirection: 'column', gap: '25px', marginTop: '10px' }}>
              ...
              <Grid>
                <Button onClick={() => this.setState({ add: false })} style={{ float: 'right', padding: '7px 30px', marginRight: '22px' }} className='create-btn' variant="contained">Save</Button>
              </Grid>
            </Grid>
          </Box>
        </Modal>
        ...
        <Dialog open={this.state.deleteleadadmin}>
                    <Grid style={{ height: "210px", width: "300px" }}>
                        ...
                        <Grid style={{ display: "flex", flexDirection: "row", justifyContent: "center", marginTop: "10%", gap: "10px" }}>
                            ...
                            <Button
                                onClick={() => { this.setState({ deleteleadadmin: false }); }}
                                variant='contained' style={{ backgroundColor: "gray", color: "#fff", marginRight: "4%" }} className='create-btn'>No</Button>
                        </Grid>
