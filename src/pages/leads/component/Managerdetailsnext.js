...
import Tickk from "../../image/tick-icon.png";
// import ImageIcon from '@mui/icons-material/Image';
...
export default class Managerdetailsnext extends Component {
    constructor(props) {
        super(props);
        this.state = {
            viewData: false,
    ...
    render() {
        return (
            <Grid style={{ marginTop: "10%", marginBottom: "5%" }}>
                ...
                <Grid style={{ display: "flex", flexDirection: "row", gap: 25, justifyContent: "space-between" }}>
                    <Grid>
                        <Card style={{ width: "300px", boxShadow: "2px 2px 8px 0px #66666633" }}>
                            <a href='/ManagerNewLead' style={{ textDecoration: 'none', color: 'black' }}>
                    ...
                    <Card style={{
                        ...
                        <Tabs style={{}}>
                            ...
                            <Grid
                                ...
                                <TabList className="sales" style={{ whiteSpace: "nowrap", width: "550px" }}>




                                    <Tab style={{ marginLeft: "30px" }}>Notes</Tab>
                                    <Tab style={{ marginLeft: "30px" }}>Call</Tab>
                                    <Tab style={{ marginLeft: "30px" }}>Email</Tab>
                                    <Tab style={{ marginLeft: "30px" }}>Payment</Tab>
                            ...
                            <TabPanel>
                                ...
                                <Grid style={{ padding: 15 }}>
                                    ...
                                    <Card style={{ padding: 10, marginTop: "3%" }}>
                                        ...
                                        <Divider />
                                        <Button
                                            onClick={() => { this.setState({ manageraddnote: true }); }}
                                            size='small' style={{ backgroundColor: "#3D3B3B", color: "#fff", marginTop: "2%", marginLeft: "75%", width: "100px" }}>Add Note</Button>
                                    </Card>
                                                ...
                                                <Grid style={{ display: "flex", flexDirection: "row", justifyContent: "space-between" }}>
                                                    <Grid style={{ display: "flex", flexDirection: "row" }}>
                                                        <Grid style={{ display: "flex", flexDirection: "row", width: "40%" }}>
                                                            ...
                                                            <Typography style={{ fontSize: 12, whiteSpace: "nowrap" }}>{item.notehead1} </Typography>
                                                        </Grid>
                                                        <Grid style={{ display: "flex", flexDirection: "row", marginLeft: "2%" }}>
                                                            <img style={{ height: 20, width: 20 }} src={item.noteproimg} />
                                                            <Typography style={{ fontSize: 12, whiteSpace: "nowrap" }}>{item.profilename}</Typography>
                                                        </Grid>
                                                    </Grid>
                                                    <Grid style={{ display: "flex", flexDirection: "row", marginLeft: "2%" }}>
                            ...
                            <TabPanel>
                                <Grid style={{ padding: 20 }} >
                                    <Grid style={{ display: "flex", flexDirection: "row", justifyContent: "space-between", alignItems: "center" }}>
                                        ...
                                        <Button size='small' onClick={() => this.setState({ folloup: true })} style={{ backgroundColor: "#3D3B3B", color: "#fff", marginTop: "2%", }}>Next  Followup</Button>
                                    </Grid>


                                    <Card style={{ padding: 20, marginTop: "5%" }}>
                                        <Grid style={{ display: "flex", flexDirection: "row", justifyContent: "space-between" }}>
                                            <Grid style={{ display: "flex", flexDirection: "row" }}>
                                    ...
                                    <Table style={{ marginTop: "2%" }}>
                                        ...
                                        <TableBody>
                                            <TableRow style={{ backgroundColor: "white", boxShadow: "1px 1px 1px black" }}>
                                                ...
                                                <TableCell>
                                                    <Grid onClick={() => this.setState({ download: true })} style={{ display: "flex", flexDirection: "row", cursor: 'pointer' }}>
                                                        <FileDownloadOutlinedIcon style={{ color: "blue" }} />
                                                        <Typography style={{ color: "blue", fontSize: 12, whiteSpace: "nowrap" }} >Download</Typography>
                                                    </Grid>
                                                </TableCell>
                                            </TableRow>
                                        </TableBody>
                    ...
                    <Grid style={{ height: "100%", width: "100%" }}>
                        ...
                        <Grid style={{ padding: 30 }}>
                            ...
                            <Grid style={{ display: "flex", flexDirection: "row", marginTop: "3%" }}>
                                <Typography style={{ marginTop: "3%" }}>Product Price:</Typography>
                                <TextField id="standard-basic" variant="standard" />
                            </Grid>
                            <Grid style={{ display: "flex", flexDirection: "row", marginTop: "5%" }}>
                            ...
                            <Grid style={{ display: "flex", flexDirection: "row-reverse", alignSelf: "flex-end", gap: "13px", marginTop: "9%" }}>
                ...
                <Dialog
                    open={this.state.manageraddnote}
                    onClose={() => this.setState({ manageraddnote: false })}

                >


                    <Card style={{ height: "30px", width: "200px" }}>
                        <center>
                            <Typography style={{ fontSize: "12px", fontWeight: "400", color: "gray", marginTop: "6px" }}>Notes Added Successfully</Typography>
                        </center>
                    </Card>
                ...
                <Dialog open={this.state.paymentmodal}>
                    <Box style={{ width: "560px", height: "346px", padding: "10px", alignItems: "center" }}>
                        ...
                        <Tabs style={{ marginTop: "3%" }}>
                            <TabList style={{ marginLeft: "10%", marginBottom: "2%", border: "none", display: "flex", gap: "12px", outline: "none" }}>
                                <Tab>Cash</Tab>
                                <Tab>Online</Tab>
                            </TabList>

                            <TabPanel>
                                <Box style={{ marginTop: "3%", "marginLeft": "3em", "marginBottom": "1em", "width": "80%", "gap": "26px", "display": "flex", "flexDirection": "column" }}>
                                    <Box style={{ display: "flex", flexDirection: "row", alignItems: "center" }}><Typography style={{ marginLeft: "" }}>Paid by-</Typography><TextField id="standard-basic" variant="standard" /></Box>
                                    <Box style={{ display: "flex", flexDirection: "row", alignItems: "center" }}><Typography style={{ marginLeft: "" }}>Amount paid-</Typography><TextField id="standard-basic" variant="standard" label="in figure" /></Box>
                                    <TextField id="standard-basic" label="in words" variant="standard" />
                                    <Button
                                        onClick={() => { this.setState({ paymentmodal: false }); }}

                                        style={{ width: "3em", left: "26em", backgroundColor: "grey" }} className='create-btn' variant="contained">Submit</Button>
                                </Box>

                            </TabPanel>
                            <TabPanel>
                                <Box style={{ marginLeft: "3%", display: "flex", flexDirection: 'row', alignItems: "flex-start", justifyContent: "space-between" }}>
                                    <Tabs style={{ width: "80%" }}>
                                        <TabList style={{ border: "none", border: "none", display: "flex", gap: "12px", outline: "none" }}>
                                            <Tab>Net Banking</Tab>
                                            <Tab>UPI</Tab>
                                            <Tab>Via link</Tab>
                                        </TabList>
                                        ...
                                        <TabPanel>
                                            <Box style={{ "marginLeft": "4em", "width": "80%", "gap": "26px", "display": "flex", "flexDirection": "column" }}>
                                                ...
                                                <Box style={{ display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "space-around" }}>
                                                    <Box style={{ display: "flex", flexDirection: "row", alignItems: "center" }}><Typography >UPI id-</Typography><TextField value="786788866@ybl" id="standard-basic" variant="standard" /></Box>
                                        ...
                                        <TabPanel>
                                            <Box style={{ "marginLeft": "4em", "width": "80%", "gap": "26px", "display": "flex", "flexDirection": "column" }}>
                                                ...
                                                <Box style={{ display: "flex", gap: "12px", flexDirection: "row", alignItems: "center" }}>
                                                    <Typography >Copy this</Typography>
                                                    <ContentCopyIcon />
                                                </Box>
                                            </Box>
                                        </TabPanel>
                ...
                <Dialog open={this.state.download}>
                    ...
                    <Box style={{ width: "433px", display: "flex", flexDirection: 'column', alignItems: "center" }}>
                        ...
                        <Button onClick={() => this.setState({ downloadDone: true })} style={{ backgroundColor: "black", margin: ".6em" }} className='create-btn' variant="contained">Download</Button>
                ...
                <Dialog open={this.state.downloadDone}>
                    ...
                    <Box style={{ height: "202px", width: "422px", display: "flex", flexDirection: 'column', alignItems: "center" }}>

                        <img src={Tickk} style={{ height: "30%", width: "15%", marginBottom: "3%", marginTop: "5%" }} />

                        <Typography variant='h5'>Download Successful</Typography>

                        <Button
                            onClick={() => { this.setState({ download: false, downloadDone: false }); }}
                            style={{ backgroundColor: "black", marginTop: "2em" }} className='create-btn' variant="contained">OK</Button>
                ...
                <Dialog open={this.state.folloup}>
                    {/* <Box> */}
                    <Grid style={{
                        display: "flex", justifyContent: "space-between", padding: "23px",
                    ...
                    <Box style={{ padding: "1em" }}>
                        ...
                        <Grid style={{ width: "100%", border: "0.5px solid lightgray", height: "20%", borderRadius: 5, marginTop: "7%", padding: "20px", display: "flex", flexDirection: "row" }}>
                            ...
                            <Grid>
                                <Typography style={{ fontSize: 12 }}>Follow Up</Typography>
                                <Typography style={{ fontSize: 12, marginTop: "1%" }}>{this.state.calvalue}<CalendarMonthIcon onClick={() => this.setState({ calandericon: true })} /></Typography>
