...
export default class Executivesallotment extends Component {
    constructor(props) {
        super(props);
        this.state = {
            allotmentm: '',
        ...
        this.list = () => (
            <div style={{ width: "400px", padding: "10px" }}>
                ...
                <Typography style={{ fontSize: 14, marginTop: "2%",padding:10 }}><b>Leads:</b>40 Leads</Typography>
                
               <Grid className='hidescroll' style={{height:"140px",overflowY:"scroll"}} >
               {this.state.allotmodal1.map((item) => {
                                return (
                                    <TableRow
            ...
            <Grid style={{ marginTop: "10%" }}>
                <Grid style={{ display: "flex", flexDirection: "row", justifyContent: "space-between" }}>
                    ...
                    <Grid style={{ display: "flex", flexDirection: "row", alignItems: "center", marginRight: "3%" }}>
                        ...
                        <FormControl style={{ width: "16ch", marginLeft: "2%" }}>
                        <InputLabel id="demo-simple-select-label"><Grid style={{display:"flex",alignItems:"center",gap:10}}><FilterAltOutlinedIcon/><Typography>Filter</Typography></Grid></InputLabel>
                        <Select
                            labelId="demo-simple-select-label"
                            id="demo-simple-select"
                            value={allotmentm}
                    ...
                    <Table>
                        <TableHead style={{ background: "lightgray" }}>
                            <TableRow>
                                ...
                                <TableCell style={{ color: "black" }}>Assignee</TableCell>
                                <TableCell></TableCell>
                            </TableRow>
                        </TableHead>
                        ...
                        <TableBody>
                            ...
                            {this.state.allotmentdata1.map((item) => {
                                return (
                                    <TableRow
