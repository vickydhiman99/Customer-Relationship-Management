        ...
        this.list = () => (
            <div style={{ width: "400px", padding: "10px" }}>
                ...
                <Box style={{ display: "flex", justifyContent: "space-between", alignItems: "center", }}>
                    ...
                    <Box
                        onClick={() => { this.setState({ admineditallot: true }); }}
                ...
                <Grid className='hidescroll' style={{ height: "100px", overflowY: "scroll" }} >
                    {this.state.adminallotmodal.map((item) => {
                        return (
                            <TableRow
            ...
            <Grid style={{ marginTop: "10%" }}>
                <Grid style={{ display: "flex", flexDirection: "row", justifyContent: "space-between" }}>
                    ...
                    <Grid style={{ display: "flex", flexDirection: "row", alignItems: "center", marginRight: "3%" }}>
                        ...
                        <AddBoxIcon
                            onClick={() => { this.setState({ admincreateallot: true }); }}
                ...
                <Grid style={{ marginTop: "2%" }}>
                    <Table>
                        ...
                        <TableBody>
                            ...
                            {this.state.adminallotmentdata.map((item) => {
                                return (
                                    <TableRow
                                        ...
                                        <TableCell>
                                            <Grid style={{ display: "flex", alignItems: "center" }}>
                                                <CircularProgress variant="determinate" value={75} style={{
                                                    ...
                                                    thickness={6}
                                                />
                                                <Typography>  {item.empstatus}</Typography>
                                            </Grid>
                                        </TableCell>
                                        ...
                                        <TableCell>
                                            <Grid style={{ display: "flex", alignItems: "center" }}>
                                                ...
                                                <DeleteOutlineOutlinedIcon
                                                    onClick={() => { this.setState({ admindeleteallot: true }); }}
                ...
                <Dialog open={this.state.admincreateallot}>
                    <Grid style={{ height: "auto", width: "600px" }}>
                        <Grid style={{ display: "flex", flexDirection: "row", justifyContent: "space-between", padding: 10, backgroundColor: "lightgray" }}>
                            ...
                            <CloseOutlinedIcon
                                onClick={() => { this.setState({ admincreateallot: false }); }}
                        ...
                        <Grid style={{ padding: 20 }}>
                            ...
                            <Grid style={{ display: "flex", flexDirection: "row", alignItems: "center", marginTop: "3%" }}>

                                <Box style={{ paddingTop: "5px", display: "flex", flexDirection: "row", width: "116px", height: "31px", borderRadius: "10px", background: "#F2F2F2" }}>

                                    <Typography style={{ marginLeft: "10px" }}>SK YU</Typography>
                                    <CloseIcon style={{ marginLeft: "20px" }} />
                                </Box>
                                <Box style={{ marginLeft: "2%", paddingTop: "5px", display: "flex", flexDirection: "row", width: "116px", height: "31px", borderRadius: "10px", background: "#F2F2F2" }}>
                ...
                {/* ----------edit--------------- */}
                <Dialog open={this.state.admineditallot}>
                    <Grid style={{ height: "auto", width: "600px" }}>
                        <Grid style={{ display: "flex", flexDirection: "row", justifyContent: "space-between", padding: 10, backgroundColor: "lightgray" }}>
                            <Typography style={{ fontSize: "20px", fontWeight: "600" }}>Create Allotment</Typography>
                            <CloseOutlinedIcon
                ...
                {/* ---------------delete------------ */}
                <Dialog open={this.state.admindeleteallot}>
                    <Grid style={{ height: "210px", width: "300px" }}>
                        ...
                        <Grid style={{ display: "flex", flexDirection: "row", justifyContent: "center", marginTop: "10%", gap: "10px" }}>
                            <Button
                                onClick={() => { this.setState({ admindeleteallot: false }); }}
                                variant='outlined' style={{ borderColor: "gray", color: "gray" }}>Cancel</Button>
                            <Button
                                onClick={() => { this.setState({ admindeleteallot: false }); }}
                                variant='contained' style={{ backgroundColor: "gray", color: "#fff", marginRight: "4%" }}>Delete</Button>
                        </Grid>
